...
export default async function () {
	await db.insert(Meals).values([
		...
		{ meal_id: 2, meal_type: 'dinner', name: 'Flatbread pizza', day: new Date('2024-03-25'), macrofactor_url: 'https://macrofactor.com/flatbread-pizza', notes: 'Use whole wheat flatbread' },
	])
}
